...
public class ClaimHandler {
	...
	public ClaimHandler(FactionsPlugin plugin) {
		this.plugin = plugin;
	...
	public boolean tryPurchasing(Player player, Claim claim) {
		...
		if (claimPrice > factionBalance) {
			player.sendMessage(ChatColor.RED + "Your faction bank only has " + EconomyManager.ECONOMY_SYMBOL + factionBalance + ", the price of this claim is " + EconomyManager.ECONOMY_SYMBOL + claimPrice + '.');
