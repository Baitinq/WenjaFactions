 ...
 * <p>
 * <p>Cannot be a {@link Cuboid} as the implementation doesn't allow null locations.
 */
public class ClaimSelection implements Cloneable {
	...
	public int getPrice(PlayerFaction playerFaction, boolean selling) {
		...
		return pos1 == null || pos2 == null ? 0 : FactionsPlugin.getInstance().getClaimHandler().calculatePrice(new Cuboid(pos1, pos2), playerFaction.getClaims().size(), selling);
	}
