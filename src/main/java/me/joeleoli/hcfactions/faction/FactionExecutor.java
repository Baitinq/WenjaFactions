...
import me.joeleoli.hcfactions.faction.argument.*;
import me.joeleoli.hcfactions.faction.argument.staff.*;
...
public class FactionExecutor extends ArgumentExecutor {
	...
	public FactionExecutor(FactionsPlugin plugin) {
		super("faction");
		...
		addArgument(new FactionGiveBalArgument(plugin));
