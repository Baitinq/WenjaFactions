...
public class EventSignListener implements Listener {
	...
	public static ItemStack getEventSign(String playerName, String kothName) {
		...
		meta.setLore(Lists.newArrayList(ChatColor.GOLD + playerName, ChatColor.DARK_PURPLE + "captured by", ChatColor.GOLD + kothName, DateTimeFormats.DAY_MTH_HR_MIN_SECS.format(System.currentTimeMillis())));
