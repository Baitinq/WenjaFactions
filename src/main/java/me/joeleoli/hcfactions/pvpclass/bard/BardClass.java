package me.joeleoli.hcfactions.pvpclass.bard;
...
public class BardClass extends PvpClass implements Listener {
	...
	public BardClass(FactionsPlugin plugin) {
	...
	public void onItemHeld(PlayerItemHeldEvent event) {
		...
		if (newStack != null) {
			...
			if (bardEffect != null) {
				...
				player.sendMessage(ChatColor.GOLD + "\u00bb " + ChatColor.YELLOW + "Clickable Effect: " + ChatColor.AQUA + Lang.fromPotionEffectType(bardEffect.clickable.getType()) + ' ' + (bardEffect.clickable.getAmplifier() + 1) + ChatColor.GRAY + " (" + (bardEffect.clickable.getDuration() / 20) + "s)");
