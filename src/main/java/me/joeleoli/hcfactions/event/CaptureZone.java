...
public class CaptureZone implements ConfigurationSerializable {
	...
	/**
	 * Constructs an {@link CaptureZone} with a given name, {@link Cuboid}, default capture time and
	 * an empty prefix.
	 *
	...
	/**
	 * Constructs an {@link CaptureZone} with a given name, prefix, {@link Cuboid} and default capture
	 * time.
	 *
	 * @param name                 the name to construct with
