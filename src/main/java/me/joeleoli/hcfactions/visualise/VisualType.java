...
public enum VisualType {
	...
	CLAIM_MAP() {
				private final BlockFiller blockFiller = new BlockFiller() {
					private final Material[] types = new Material[]{Material.SNOW_BLOCK, Material.SANDSTONE, Material.FURNACE, Material.NETHERRACK, Material.GLOWSTONE, Material.LAPIS_BLOCK, Material.NETHER_BRICK, Material.DIAMOND_ORE, Material.COAL_ORE, Material.IRON_ORE, Material.GOLD_ORE, Material.LAPIS_ORE, Material.REDSTONE_ORE};
					...
					VisualBlockData generate(Player player, Location location) {
						...
						Faction faction = FactionsPlugin.getInstance().getFactionManager().getFactionAt(location);
