...
public class KothSetCapDelayArgument extends CommandArgument {
	...
	public KothSetCapDelayArgument(FactionsPlugin plugin) {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		Bukkit.broadcastMessage(ChatColor.YELLOW + "The capture time of " + ChatColor.RED + kothFaction.getDisplayName(sender) + ChatColor.YELLOW + " has been set to " + ChatColor.RED + DurationFormatUtils.formatDurationWords(duration, true, true) + ChatColor.YELLOW + '.');
