...
public class VisualiseHandler {
	...
	/**
	 * Gets the current {@link VisualBlock}s to their {@link Location}s that are shown to a {@link
	 * Player} of a specific {@link VisualType}.
	 *
	 * @param player the {@link Player} to get for
	 ...
	 * @param player            the player to clear for
	 * @param location          the location to clear at
	 * @param sendRemovalPacket if a packet to send a block change should be sent (this is used to
	 *                          prevent unnecessary packets sent when disconnecting or changing worlds, for example)
	 * @return if the visual block was shown in the first place
	 */
	 ...
	 * @param visualType         the visual type
	 * @param predicate          the predicate to filter to
	 * @param sendRemovalPackets if a packet to send a block change should be sent (this is used to
	 *                           prevent unnecessary packets sent when disconnecting or changing worlds, for example)
	 * @return mapping of the removed visualises
	 */
	@Deprecated
