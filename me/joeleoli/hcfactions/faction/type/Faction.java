...
import me.joeleoli.hcfactions.faction.event.FactionRenameEvent;
...
public abstract class Faction implements ConfigurationSerializable {
	...
	public Relation getRelation(CommandSender sender) {
		return sender instanceof Player ? getFactionRelation(FactionsPlugin.getInstance().getFactionManager().getPlayerFaction((Player) sender)) : Relation.ENEMY;
	}
	...
	/**
	 * Checks if a deathban will be applied when players are killed in the territory of this {@link
	 * Faction}.
	 *
	...
	/**
	 * Sets if a deathban will be applied when players are killed in the territory of this {@link
	 * Faction}.
	 * <p>
	 * <p>Setting to true will set the DTR multiplier to 1.0
	 *
	 ...
	 * <p>
	 * <p>To disable deathbans completely, set the multiplier to 0
	 *
