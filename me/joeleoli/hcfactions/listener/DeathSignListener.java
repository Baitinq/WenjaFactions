...
public class DeathSignListener implements Listener {
	...
	public DeathSignListener(FactionsPlugin plugin) {
	...
	public static ItemStack getDeathSign(String playerName, String killerName) {
		...
		meta.setLore(Lists.newArrayList(ChatColor.RED + playerName, ChatColor.DARK_RED + "slain by", ChatColor.GREEN + killerName, DateTimeFormats.DAY_MTH_HR_MIN_SECS.format(System.currentTimeMillis())));
